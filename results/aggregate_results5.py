...
def main():
    ...
    for index, project in enumerate(projects):
        first_fail, apfd = read_results(['clfp5_k200.csv'],
...
#        columns = ['cl11', 'cl12', 'cl21', 'cl22', 'clf1_at', 'clf1_aa', 'clf8_at', 'clf8_aa', 'clf9_at', 'clf9_aa',
#                   'fp2_1__1_at', 'fp2_1__1_aa', 'tot', 'tot_fp', 'add', 'add_fp']
