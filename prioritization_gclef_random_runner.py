import pandas as pd
from prioritization.prioritization_manager import run_gclef_prioritization, run_gclef_random_prioritization
...
for index, project in enumerate(projects):
    ...
    for version_number in range(from_version[index], to_version[index] + 1):
        ...
        run_gclef_random_prioritization(bug_prediction_data, 'xgb_score_online', project, version_number, 'gclef_random_xgb_results_14001115_online.csv',
                                         'gclef_random_xgb_results_14001115_online')
        print()
