...
for index, project in enumerate(projects):
    ...
    for version_number in range(from_version[index], to_version[index] + 1):
        ...
        run_gclef_prioritization(bug_prediction_data, 'xgb_score_online', project, version_number, 'gclef3_xgb_results_14001115_online.csv',
                                         'gclef3_xgb_results_14001115_online')
        print()
