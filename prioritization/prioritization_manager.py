...
def run_prioritization_clustering_fp(bug_prediction_data, clustering_method, project, version_number, cluster_num, c_dp_values, filename, alg_prefix):
    ...
    clusters, clustering = pr_cl.create_clusters(coverage, clustering_method, cluster_num)
