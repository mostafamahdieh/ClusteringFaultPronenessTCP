...
def art_tcp_fast(coverage, cand_set_function):
    eps = 1.0e-8
    inf = 1.0e100
    ...
    while len(remaining_tests) > 0:
        ...
        while len(candidate_set) > 0:
            ...
            if len(candidate_set) == 1:
                ...
                new_dists = euclidean_distances(coverage[[last_prioritized]], coverage[candidate_set_list])
                ...
                for candidate_test in candidate_set_list:
                    ...
                    for src in prioritized:
                        ...
                        if not (src, candidate_test) in dist_dict:
                            d = euclidean_distances(coverage[[src]], coverage[[candidate_test]])[0][0]
