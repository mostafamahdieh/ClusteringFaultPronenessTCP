...
from prioritization.prioritization_clustering import clustering_agg3
...
for project in projects:
    ...
    for version_number in range(from_version[index], to_version[index] + 1):
        ...
        run_prioritization_clustering_fp(bug_prediction_data, project, version_number, clustering_agg3, 200,
                                         [0, 0.999], 'agg3_200.csv',
                                         ['agg3_200_c0', 'agg3_200_c0999'])
        print()
    index = index + 1
