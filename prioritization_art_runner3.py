...
for index, project in enumerate(projects):
    for version_number in range(from_version[index], to_version[index] + 1):
        ...
        run_art_prioritization(project, version_number, 'art3_rnd.csv', art_create_candidate_set, euclidean_distances, 'art3_rnd', 10, 'cache-precomputed')
